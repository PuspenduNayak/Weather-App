    ...
    class getWeather extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... urls){
            ...
            try {
                ...
                HttpURLConnection urlorrection = (HttpURLConnection) url.openConnection();
                urlorrection.connect();

                InputStream inputStream = urlorrection.getInputStream();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if (city != null) {
                        url = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=cbc9015126156ed02d28ca43bda76e36";
                    }
                    else {
